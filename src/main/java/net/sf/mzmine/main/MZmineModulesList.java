...
import net.sf.mzmine.modules.peaklistmethods.peakpicking.adapsimplespectraldeconvolution.SimpleSpectralDeconvolutionModule;
...
public class MZmineModulesList {
  ...
  public static final Class<?> MODULES[] = new Class<?>[] {
      ...
      ADAP3DecompositionV1_5Module.class, ADAP3DecompositionV2Module.class, SimpleSpectralDeconvolutionModule.class,
